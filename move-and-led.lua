...
local moveSensorPin = 1     -- GPIO5

local pinRed = 7            -- GPIO13
local pinGreen = 6          -- GPIO12
local pinBlue = 5           -- GPIO14
...
local ledDriver = LedDriver.init(pinRed, pinGreen, pinBlue)
local lightSensor = LightSensor.init(850, 900)
